...
class Authentication:
    ...
    def login(self, email, password):
        if email in self.__users and self.__users[email] == password:
            return True
        else:
            return False
...
if __name__ == "__main__":
    ...
    shop.add_product(PhysicalProduct("Laptop", 1200, 2.5))
    shop.add_product(PhysicalProduct("Smartphone", 700, 0.3))
    shop.add_product(PhysicalProduct("Headphones", 100, 0.5))
    shop.add_product(PhysicalProduct("Smartwatch", 250, 0.2))
    shop.add_product(PhysicalProduct("Bluetooth Speaker", 80, 1.2))
    shop.add_product(PhysicalProduct("Gaming Console", 500, 3.0))
    shop.add_product(PhysicalProduct("Refrigerator", 1500, 80))
    shop.add_product(PhysicalProduct("Microwave Oven", 300, 25))
    shop.add_product(PhysicalProduct("Dishwasher", 900, 60))
    shop.add_product(PhysicalProduct("Air Conditioner", 1200, 45))
    shop.add_product(PhysicalProduct("LED TV", 1000, 20))
    shop.add_product(PhysicalProduct("Vacuum Cleaner", 200, 8))
    shop.add_product(PhysicalProduct("Leather Jacket", 150, 1.5))
    shop.add_product(PhysicalProduct("Sneakers", 120, 1))
    shop.add_product(PhysicalProduct("Backpack", 50, 0.8))
    shop.add_product(PhysicalProduct("Wristband", 30, 0.1))
    shop.add_product(PhysicalProduct("Office Chair", 250, 15))
    shop.add_product(PhysicalProduct("Table Lamp", 40, 3))
    shop.add_product(PhysicalProduct("Coffee Maker", 100, 5))
    shop.add_product(PhysicalProduct("Bookshelf", 180, 25))
